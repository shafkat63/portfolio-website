...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
	...
	return (
		...
		>
			<section
				className=" bg-gray-100 max-w-[42rem] border rounded-lg border-black/5
         ...
         "
            ...
            flex flex-col h-full sm:group-even:ml-[18rem]"
				...
				<Image
					...
					quality={95}
					className="absolute hidden sm:block top-8  -right-40 w-[28.25rem] rou-t-lg shadow transition
